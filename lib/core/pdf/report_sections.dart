...
class ReportSections {
            ...
            children: [
              ...
              pw.Container(
                decoration: pw.BoxDecoration(
                  border: pw.Border.all(color: ReportStyles.accentColor, width: 2),
                  ...
                  children: [
                    ...
                    pw.Container(
                      ...
                      decoration: pw.BoxDecoration(
                        ...
                        border: pw.Border.all(color: PdfColor.fromHex('#C5A059').flatten()),
                      ),
                      child: pw.Column(
                        children: [
          ...
          children: [
            pw.Expanded(
              child: PdfWidgets.infoCard(
                ...
                children: [
                  _buildSummaryItem('Ascendant', chartData.baseChart.ascendantSign, body, bodyBold),
                  _buildSummaryItem('Moon Sign', chartData.baseChart.planets[Planet.moon]?.zodiacSign ?? 'N/A', body, bodyBold),
                  _buildSummaryItem('Sun Sign', chartData.baseChart.planets[Planet.sun]?.zodiacSign ?? 'N/A', body, bodyBold),
                  _buildSummaryItem('Nakshatra', chartData.baseChart.planets[Planet.moon]?.nakshatra ?? 'N/A', body, bodyBold),
                ],
              ),
            ),
            ...
            pw.Expanded(
              child: PdfWidgets.infoCard(
                ...
                children: [
                  _buildSummaryItem('Mahadasha', currentDasha['mahadasha'] ?? 'N/A', body, bodyBold),
                  _buildSummaryItem('Antardasha', currentDasha['antardasha'] ?? 'N/A', body, bodyBold),
                  _buildSummaryItem('Ends On', _formatDate(currentDasha['antarEnd'] as DateTime? ?? DateTime.now()), body, bodyBold),
                ],
              ),
            ),
          ],
          ...
          return pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 8),
                pw.Text(aspect.prediction, style: body, textAlign: pw.TextAlign.justify),
                pw.SizedBox(height: 4),
                pw.Text('Advice: ${aspect.advice}', style: body.copyWith(fontStyle: pw.FontStyle.italic, color: ReportStyles.primaryColor)),
              ],
            ),
          );
        }),
    ...
    return pw.Column(
      ...
      children: [
          ...
          child: pw.Row(
            children: [
              pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text('Overall Quality: ${analysis.qualityLabel}', style: h3.copyWith(color: ReportStyles.primaryColor)),
                  pw.SizedBox(height: 4),
                  pw.Container(
                    width: 400,
                    child: pw.Text(analysis.qualityDescription, style: body.copyWith(fontSize: 9)),
                  ),
                ],
              ),
              pw.Spacer(),
        ...
        if (analysis.yogas.isEmpty)
          pw.Text('No major auspicious yogas detected.', style: body.copyWith(fontStyle: pw.FontStyle.italic))
        else
          PdfWidgets.premiumTable(
            headers: ['Yoga Name', 'Strength', 'Peak Period'],
            rows: analysis.yogas.map((y) => [
              y.name,
              '${y.strength.toInt()}%',
        ...
        if (analysis.doshas.isEmpty)
          pw.Text('No major doshas detected in the chart.', style: body.copyWith(fontStyle: pw.FontStyle.italic))
        else
          PdfWidgets.premiumTable(
            headers: ['Dosha Name', 'Status', 'Impact Period'],
            rows: analysis.doshas.map((d) => [
              d.name,
              d.status,
              d.manifestationPeriod,
            ]).toList(),
            bodyStyle: body.copyWith(fontSize: 9),
          ),
  ...
  static Future<pw.Widget> buildVarshaphalPage1(
    ...
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
      children: [
        PdfWidgets.sectionHeader('Annual Analysis (Varshaphal - ${varsha.year})', h2),
        pw.Text(
              ...
              child: pw.Column(
                children: [
                  PdfWidgets.infoCard(
                    ...
                    children: [
                      _buildSummaryItem('Year Lord', varsha.yearLord, body, body),
                      _buildSummaryItem('Muntha Sign', VarshaphalSystem.getSignName(varsha.muntha), body, body),
                      _buildSummaryItem('Muntha Lord', varsha.munthaLord, body, body),
                    ],
                  ),
                  ...
                  PdfWidgets.infoCard(
                    ...
                    children: [
                      _buildSummaryItem('Return Time', _formatDate(varsha.solarReturnTime), body, body),
                      _buildSummaryItem('Return Status', varsha.isDayBirth ? 'Day Birth' : 'Night Birth', body, body),
                    ],
                  ),
                ],
              ),
    ...
    return pw.Column(
      ...
      children: [
        ...
        PdfWidgets.premiumTable(
          ...
          rows: varsha.varshikDasha.map((d) => [
                d.planet,
            ...
            pw.Expanded(
              child: pw.Column(
                ...
                children: [
                  ...
                  ...varsha.tajikYogas.map((y) => pw.Bullet(text: y, style: body.copyWith(fontSize: 9))),
                ],
              ),
            ),
            pw.SizedBox(width: 20),
            pw.Expanded(
              child: pw.Column(
                ...
                children: [
                  ...
                  ...varsha.sahams.entries.take(5).map((e) => pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.start,
                        children: [
                          pw.Text('${e.key}: ${VarshaphalSystem.getSignName(e.value.sign)} ${e.value.degreeInSign.toStringAsFixed(2)}°',
                              style: body.copyWith(fontWeight: pw.FontWeight.bold, fontSize: 9)),
                          pw.Text(e.value.interpretation, style: body.copyWith(fontSize: 8)),
                          pw.SizedBox(height: 4),
                        ],
                      )),
                ],
  ...
  static pw.Widget _buildInfoRow(String label, String value) {
    return pw.Padding(
      ...
      child: pw.Row(
        children: [
          pw.Text('$label: ', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, color: ReportStyles.primaryColor)),
          pw.Text(value),
        ],
      ),
    );
  ...
  static pw.Widget _buildSummaryItem(String label, String value, pw.TextStyle body, pw.TextStyle bodyBold) {
    return pw.Padding(
  ...
  static Map<String, Map<String, dynamic>> _convertVarshaToSignificators(
    ...
    for (final p in planets) {
      ...
      final longitude = VarshaphalSystem.getPlanetLongitude(varsha.chart, pEnum);
      map[p] = {
        'position': longitude,
        'house': 0,
      };

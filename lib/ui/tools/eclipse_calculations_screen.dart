...
class EclipseCalculationsScreen extends StatefulWidget {
  ...
  @override
  State<EclipseCalculationsScreen> createState() => _EclipseCalculationsScreenState();
}
...
class _EclipseCalculationsScreenState extends State<EclipseCalculationsScreen> {
  ...
  Future<void> _calculateEclipses() async {
    ...
    try {
      ...
      final yearEclipses = await EphemerisManager.jyotish.eclipse.predictEclipsesInYear(
        year: _selectedYear,
        location: location,
      );
      ...
      if (_selectedType != EclipseType.any) {
        if (_selectedType == EclipseType.solar) {
          ...
          filtered = yearEclipses.where((e) => e.eclipseType == _selectedType).toList();
        }
      }
                      ...
                      SizedBox(
                        ...
                        child: InfoLabel(
                          ...
                          child: ComboBox<EclipseType>(
                            ...
                            items: [
                              const ComboBoxItem(value: EclipseType.any, child: Text('Any Eclipse')),
                              const ComboBoxItem(value: EclipseType.solar, child: Text('All Solar')),
                              const ComboBoxItem(value: EclipseType.lunar, child: Text('All Lunar')),
                              const ComboBoxItem(value: EclipseType.solarTotal, child: Text('Solar Total')),
                              const ComboBoxItem(value: EclipseType.solarPartial, child: Text('Solar Partial')),
                              const ComboBoxItem(value: EclipseType.solarAnnular, child: Text('Solar Annular')),
                              const ComboBoxItem(value: EclipseType.lunarTotal, child: Text('Lunar Total')),
                              const ComboBoxItem(value: EclipseType.lunarPartial, child: Text('Lunar Partial')),
                              const ComboBoxItem(value: EclipseType.lunarPenumbral, child: Text('Lunar Penumbral')),
                            ],
                          ),
                        ),
                      ),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Icon(
                                                eclipse.eclipseType.name.contains('Solar')
                                              ...
                                              Text(
                                                eclipse.eclipseType.name.replaceAll('Solar ', '').replaceAll('Lunar ', ''),
                                                style: TextStyle(
                                                  color: color,
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              if (eclipse.startTime != null && eclipse.endTime != null)
                                                Text(

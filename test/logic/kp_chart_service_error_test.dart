...
void main() {
  group('KPChartService Error Handling Regression Tests', () {
    test(
      'generateCompleteChart should return null when invalid coordinates are provided',
      () async {
    ...
    test(
      'generateKPChart should return null when generateCompleteChart returns null',
      () async {
        final service = KPChartService();
        final invalidBirthData = BirthData(
          dateTime: DateTime.now(),
